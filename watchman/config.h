...
/* Define to 1 if you have the `FSEventStreamSetExclusionPaths' function. */
/* #undef HAVE_FSEVENTSTREAMSETEXCLUSIONPATHS */

/* Define to 1 if you have the `getattrlistbulk' function. */
/* #undef HAVE_GETATTRLISTBULK */
...
/* Define to 1 if you have the <libgimli.h> header file. */
/* #undef HAVE_LIBGIMLI_H */
...
/* sys/fsevents.h location */
/* #undef SYS_FSEVENTS_PATH */
...
#define WATCHMAN_STATE_DIR "/usr/local/var/run/watchman"
